...
\begin{equation}
  \label{eq:A.3}
  g^l_{i.j}=\frac{(m_{ij}-d_{l-1})^3}{6(d_l-d_{l-1})}
\end{equation}
...
\begin{equation}
  \label{eq:A.4a}
  g^l_{i,j} = \frac{c^2}{6}+\frac{ce}{2}+\frac{e^2}{2}-\frac{e^3}{6(d_{l+1}-d_l)}
\end{equation}
...
\begin{equation}
  \label{eq:A.5}
  g^l_{i,j} = (d_{l+1}-d_{l-1})\left[\frac{2d_{l+1}-d_l-d_{l-1}}{6}+\frac{m_{ij}-d_{l+1}}{2}\right]
\end{equation}
