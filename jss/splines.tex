...
Whereas $(\cdot)$ denotes again a element by element multiplication and $( )'$ the transposed matrix (vector).
...
The estimated parameters can be used to calculate the discount function in \eqref{eq:df_spline} for any given maturity $m$ between the first and the last knot point, which can then be converted to the spot rate function.
