...
Our package contains many functions to perform typical fixed income mathematics operations. Table~\ref{tab:helpfct} shows the most important ones. The package includes serveral more functions. For a description of them we may refer to the technical documentation. 
