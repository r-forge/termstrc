...
In this section, we define a matrix-oriented notation and briefly describe the estimation procedure which is important for the implementation of the \pkg{termstrc} package presented in this paper.
