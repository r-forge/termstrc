...
In this section, we define a matrix-oriented notation and briefly describe the estimation procedure which is import for the implementation of the \pkg{termstrc} package described in this paper.
