...
plot(m, nelson(m,b[1,]), ylim=c(-1,8),type="l")
...
par(mfrow=c(2,4))
plot(m, svensson(b[1,],m),type="l")

plot(m,svensson(c(5,-1,1,1,1,1,10),m), type="l")

plot(m,svensson(c(5,-4,-15,1,0.1,6,4),m), type="l")

#plot(m,svensson(c(5,-4,-1,10,4,0.5,7),m), type="l")
plot(m,svensson(c(5,-4,-1,15,4,0.5,4),m), type="l")

plot(m,svensson(c(5,-4,-1,10,15,0.5,1),m), type="l")

plot(m,svensson(c(5,-4,-5,15,15,0.1,1),m), type="l")

plot(m,svensson(c(5,-4,-5,15,10,2,10),m), type="l")

plot(m,svensson(c(5,-4,1 ,1,4,2,1),m), type="l")
