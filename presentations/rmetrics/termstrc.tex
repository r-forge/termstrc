...
\begin{frame}
	...
	$$\bm{G}_{\left[n \times m\right]} = \{  g(m_{ij},l) \} \qquad   l = 1\dots INT[\sqrt{m}]$$
	\end{block}
	
	\begin{block}{Predictor matrix}
	$$\bm{X}_{\left[m \times s\right]}=$$
	\end{block}
	
	\begin{block}{Response vector}
	$$\bm{y}_{\left[m \times 1\right]}=$$
	\end{block}
...
%Charles R. Nelson and Andrew F. Siegel (1987): Parsimonious modeling of yield curves. The Journal of Business, 60(4):473Ð489.
